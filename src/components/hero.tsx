  ...
  return (
    <section className="bg-white px-4 pt-16 md:pt-24 lg:px-8 ">
      <div className="mx-auto max-w-md md:max-w-4xl text-center  border-b border-Grey-300  ">
        ...
        <div className="flex flex-col space-y-3 md:flex-row-reverse md:space-y-0 md:justify-center sm:mb-4 md:mb-0">
          <button className="w-full md:w-auto ml-3 bg-primary justify-center rounded-lg py-3 px-5 text-center text-md text-white font-semibold hover:bg-primary-800 transition-colors duration-300">
            Launch the App
          </button>
